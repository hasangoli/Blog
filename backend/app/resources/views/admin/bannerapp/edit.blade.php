        ...
        <div class="row px-3">
            <div class=" col-sm-12 col-md-8 mx-auto  py-3">
                <div class="card p-4">
                    ...
                    <div class="content">
                        {!! Form::open(['route' => ['admin.banner-app.update',$banner_app->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data']) !!}
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="title" name="link" class="form-control border-input"
                                               placeholder="لینک" value="{{ old('link',$banner_app->link) }}">
                                    </div>
                                </div>
                                    ...
                                    <div class="my-4 my-1 drop-region" >
                                        ...
                                        <div class="image-preview">
                                            @if($banner_app->image)
                                                ...
                                                <img class="thumbnail" src="{{ asset('storage/bannerapp/'.$banner_app->image) }}" alt=""
                                                title="default">
