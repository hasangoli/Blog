        ...
        <div class="row px-3">
            <div class="col-md-12 py-3 card">
                <div class="card-header">
                    ...
                    <a href="{{ route('admin.products.create') }}" class="btn btn-outline-success btn-icon-text"><i
                    ...
                    <div class="table-responsive">
                        <table id="products" class="display" style="width:100%">
                            <thead class="text-primary primary-font">
                                ...
                                <th class="text-center">قیمت به پوند</th>
                                <th class="text-center">قیمت به تومن</th>
                            ...
                            @forelse ($products as $product)
                                <tr>
                                    ...
                                    <td class="text-center">{{$product->categories()->first()->title}}</td>
                                    <td class="text-center">{{$product->pricePound}}</td>
                                    <td class="text-center">{{toPersianMoney($product->priceToman)}}</td>
                                    <td class="text-center">
                                        ...
                                        <form action="{{route('admin.products.destroy' , $product->id)}}?_method=DELETE"
                                              method="POST" id="delete-item-{{$product->id}}">
                                            @csrf
                                            @method('delete')
