            ...
            <div class=" col-sm-12 col-md-8 mx-auto  py-3">
                <div class="card p-4">
                    ...
                    <div class="content">
                        ...
                        {!! Form::open(['route' => 'admin.galleries.store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <option value="yellowCard" @if (old('type') == 'yellowCard') selected @endif>کارت زرد</option>
                                        <option value="greenCard" @if (old('type') == 'greenCard') selected @endif>کارت سبز</option>
                                        <option value="BritainInTheMirrorOfHistory" @if (old('type') == 'BritainInTheMirrorOfHistory') selected @endif>بریتانیا در آیینه تاریخ</option>
                                        <option value="interview" @if (old('type') == 'interview') selected @endif> مصاحبه </option>
                                        <option value="pictures" @if (old('type') == 'pictures') selected @endif>تصاویر</option>
                                        </select>
                                    </div>
                                </div>
