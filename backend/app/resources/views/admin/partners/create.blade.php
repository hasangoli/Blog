            ...
            <div class=" col-sm-12 col-md-8 mx-auto  py-3">
                <div class="card p-4">
                    ...
                    <div class="content">
                        ...
                        {!! Form::open(['route' => 'admin.partners.store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="url" id="url" name="url" class="form-control border-input"
                                               placeholder="لینک" value="">
                                    </div>
                                </div>
